  ...
  return (
    ...
    >
      <div
        className={cn(
          landing.container,
          "flex h-14 items-center justify-between gap-3 px-4 sm:h-16 sm:px-6"
        )}
      >
      ...
      {open && (
        <div className="max-h-[calc(100dvh-3.5rem)] overflow-y-auto border-t border-border bg-background lg:hidden">
